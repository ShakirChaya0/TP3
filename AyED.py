...
def gestion_de_locales():
  ...
  while decision != "a" and decision != "b" and decision != "c" and decision != "d" and eleccion == 1:
    ...
    if decision != "a" and decision != "b" and decision != "c" and decision != "d" and decision != "e":
      ...
      os.system("cls")
      locales_cargados = input("¿Desea ver los locales cargados hasta el momento?(Si o No): ")
...
def Crear_Locales():
  ...
  nombre = input("Ingrese el nombre del local (si no quiere crear locales ingrese 0): ")
  nombre = nombre.lower()
  while len(nombre) > 30:
    print("Usted ingreso un nombre muy largo... ")
    separador()
    nombre = input("Ingrese un nombre mas corto (si no quiere crear locales ingrese 0): ")
    nombre = nombre.lower()
  ...
  while nombre != "0":
    ...
    if nombre != "0":
      ...
      #Cargando Rubro:
      rubro = input("Ingrese el tipo de rubro del local (perfumería, comida o indumentaria): ")
      rubro = rubro.lower()
      
      #Verificacíon y carga del rubro
      while rubro != "perfumeria" and rubro != "perfumería" and rubro !="indumentaria" and rubro != "comida":
        print("Usted no ingreso los datos correctamente porfavor intentelo otra vez...")
        separador()
...
def Modificar_Locales():
  ...
  def Modificacion():
    ...
    modif = input("Que parte del local desea modificar(nombre, ubicación, rubro o codigo de usuario)? ")
    modif = modif.lower()
    separador()
    while modif != "nombre" and modif != "ubicacion" and modif != "ubicación" and modif != "rubro" and modif != "codigo de usuario" and modif != "0":
    ...
    #Modificación del rubro
      ...
      while rubro != "perfumeria" and rubro != "perfumería" and rubro != "indumentaria" and rubro != "comida":
        print("Usted no ingreso los datos correctamente, porfavor intentelo otra vez")
        separador()
        rubro = input("Ingrese el nuevo rubro del local (perfumeria, comida o indumentaria): ")
        rubro = rubro.lower()
      tipo = Datos_Locales[valor][2]
      pos_rest = Bs_Sec_R(Rubros[:],tipo)
      pos_suma = Bs_Sec_R(Rubros[:],rubro)
      if Datos_Locales[valor][2] == "perfumeria" or Datos_Locales[valor][2] == "perfumería":
  ...
  cod_local = input("Ingrese el codigo del local que desea modificar(si no desea modificar ninguno ingrese 0): ")
  while cod_local != "0":
    if cod_local.isdigit():
      ...
      if valor == -1:
        ...
        if Datos_Locales[valor][3] == "B":
          ...
          if rta == "no":
            separador()
            cod_local = input("Ingrese el codigo de otro local que desee modificar(si no desea modificar ninguno ingrese 0): ")
          else:
            pos = Bs_Sec(Cod_loc[:][:],cod_local)
            Datos_Locales[pos][3] = "A"
            if Datos_Locales[pos][2] == "perfumeria" or Datos_Locales[pos][2] == "perfumería":
            ...
            Modificacion()
            separador()
            cod_local = input("Ingrese el siguiente codigo del local que desea modificar(si no desea modificar ninguno ingrese 0): ")
        else:
          Modificacion()
          separador()
          cod_local = input("Ingrese el siguiente codigo del local que desea modificar(si no desea modificar ninguno ingrese 0): ")
...
def Eliminar_Locales():
  eliminar = input("Ingrese el codigo del local que desea eliminar(si no desea eliminar ninguno ingrese 0): ")
  while eliminar != "0":
    if eliminar.isdigit():
      ...
      if pos == -1:
        print("Usted ingreso un valor no valido, intentelo de nuevo")
        separador()
        eliminar = input("Ingrese el codigo del local que desea eliminar(si no desea modificar ninguno ingrese 0): ")
      else:
        print("Local encontrado!!!")  
        if Datos_Locales[pos][3] == "B":
          print("Este local esta dado de baja") 
          eliminar = input("Ingrese otro codigo del local que desee eliminar(si no desea eliminar ninguno ingrese 0): ")
        else:
          confirmacion = input("Desea confirmar la eliminación de este local? (si o no): ")
          ...
          if confirmacion == "no":
            ...
            separador()
            eliminar = input("Ingrese el siguiente codigo del local que desee eliminar(si no desea eliminar ninguno ingrese 0): ")
    else:
      print("Usted ingreso un valor no valido, intentelo de nuevo")
      separador()
      eliminar = input("Ingrese el codigo del local que desea eliminar(si no desea eliminar ninguno ingrese 0): ")
